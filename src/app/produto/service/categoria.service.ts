...
export class CategoriaService extends CrudService<Categoria>{
  ...
  constructor(protected http: HttpClient,protected auth:AuthServiceTest,protected oauthService: OAuthService) {
    super(http,`${environment.API}/categorias`, auth, oauthService); 
